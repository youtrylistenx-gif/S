/* ╔══════════════════════════════════════════════════════════════╗
   ║         settings.js — แก้ที่นี่ที่เดียว ทุกหน้าเปลี่ยนตาม        ║
   ╚══════════════════════════════════════════════════════════════╝
...
/* ┌──────────────────────────────────────────────────────────────┐
   │  6. จำนวนผู้ใช้งาน Planner ตอนนี้                              │
   └──────────────────────────────────────────────────────────────┘
   แก้ตัวเลขที่นี่ที่เดียว — ทุกหน้าจะอัปเดตพร้อมกันทันที            */
...
/* ┌──────────────────────────────────────────────────────────────┐
   ...
   (เปิดชีต ดูแท็บ "ผู้อ่าน - ปลุกไฟในตัวมึง" นับจำนวนแถว) แล้วแก้เลขด้านล่าง Save + push
   ขึ้น GitHub เว็บจริงถึงจะอัปเดตตาม — เหมือนกับ ACTIVE_USERS ด้านบน
   (25 = จำนวนจริงล่าสุดที่นับได้จากแท็บ "Readers" เดิม ก่อนเปลี่ยนมาใช้ระบบแยกตามเล่ม) */

var PLUKFAI_READERS = 25;


/* ┌──────────────────────────────────────────────────────────────┐
   │  8. จำนวนผู้อ่าน Ebook "ฮีลใจ"                                 │
   └──────────────────────────────────────────────────────────────┘
   วิธีอัปเดตเหมือนข้อ 7 ทุกอย่าง — เช็คจากแท็บ "ผู้อ่าน - ฮีลใจ" ในชีท
   (1652 = เลขเดิมที่เคยโชว์ไว้ในหน้าแลนดิ้งเก่า ใช้เป็นค่าเริ่มต้น) */

var HEALJAI_READERS = 1652;


/* ┌──────────────────────────────────────────────────────────────┐
   │  9. จำนวนผู้อ่าน Ebook "ชีวิตที่มึงไม่เสียใจภายหลัง"            │
   └──────────────────────────────────────────────────────────────┘
   วิธีอัปเดตเหมือนข้อ 7 ทุกอย่าง — เช็คจากแท็บ "ผู้อ่าน - ชีวิตที่มึงไม่เสียใจภายหลัง" ในชีท
   (15 = เลขเดิมที่เคยโชว์ไว้ในหน้าแรก ใช้เป็นค่าเริ่มต้น) */

var CHIWIT_READERS = 15;
...
function applyPriceConfig(cfg) {
  ...
  document.querySelectorAll('[data-active-users]').forEach(function(el) { el.textContent = ACTIVE_USERS; });
...
(function () {
  function run() {
    ...
    document.querySelectorAll('[data-healjai-readers]').forEach(function(el) {
      el.textContent = HEALJAI_READERS;
    });
  ...
  run();
  // fallback กรณีโหลดจาก <head> หรือ async

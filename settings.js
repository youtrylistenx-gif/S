...
var ACTIVE_USERS = 1028;


/* ┌──────────────────────────────────────────────────────────────┐
   │  7. จำนวนผู้อ่าน Ebook "ปลุกไฟในตัวมึง"                        │
   └──────────────────────────────────────────────────────────────┘
   ไม่ต้องมานับเองในชีทแล้ว — แค่รันคำสั่ง (ในโฟลเดอร์โปรเจกต์นี้):
       node update-reader-counts.mjs
   สคริปต์จะไปดึงจำนวนจริงจากชีทมาแก้เลขตรงนี้ให้อัตโนมัติทั้ง 3 เล่ม
   แล้วค่อย Save + push ขึ้น GitHub ตามปกติ เว็บจริงถึงจะอัปเดตตาม */

var PLUKFAI_READERS = 108;


/* ┌──────────────────────────────────────────────────────────────┐
   │  8. จำนวนผู้อ่าน Ebook "ฮีลใจ"                                 │
   └──────────────────────────────────────────────────────────────┘
   อัปเดตพร้อมกับข้อ 7 ทุกครั้งที่รัน update-reader-counts.mjs */

var HEALJAI_READERS = 43;
